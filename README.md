...
개발자의 회고에 따르면 버프 해제 문제는 약 2년 전 팀장과 함께 해결했지만, 이 저장소에는 그 이전 코드가 올라와 있었습니다. 2026-09-07 변경은 오래된 공개본에 대한 별도 보정이며, 회사 관리 하의 최종 코드를 가져오거나 대조한 것이 아닙니다. [보정 전 공개본](https://github.com/fishbowl92/InEarth3/tree/818936be937d9bea53e8eced8ac9991640bbc963)과 [공동 해결 이력·공개본 보정 기록](./docs/BUFF_STATE_FIX.md)을 구분해 안내합니다.
